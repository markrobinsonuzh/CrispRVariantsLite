...
observe({
  if(input$info){
    ...
    addTooltip(session, "select_AB1", info_AB1, placement = "left",
    ...
    addTooltip(session, "select_FastQ", info_FastQ, placement = "left",
               trigger = 'hover', options = list(container = "body"))
    ...
    addTooltip(session, "create_guides", info_guides, placement = "left",
               trigger = 'hover', options = list(container = "body"))
    ...
    addTooltip(session, "edit_xls", info_xls, placement = "left",
               trigger = 'hover', options = list(container = "body"))
